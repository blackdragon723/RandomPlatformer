...
namespace Platformer
{
    public class Camera2D
    {
        ...
        private IPosition _trackingBody;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            //_currentPosition.Y -= _graphics.Viewport.Height / 6;
            _currentPosition = new Vector2((int)_currentPosition.X, (int)_currentPosition.Y);
